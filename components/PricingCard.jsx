...
const PricingCard = ({
  ...
  return (
    ...
    >
      <div className="mx-auto mt-16 max-w-[380px] h-auto ring-1 ring-primary/30 bg-gray-50 transition dark:text-white dark:bg-gray-900 rounded-lg shadow-xl sm:mt-20 flex flex-col justify-between">
        ...
        <div className="p-2 relative transition duration-100 ease-in-out">
